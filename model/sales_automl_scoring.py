...
input_sample = pd.DataFrame({"Date": pd.Series(["2000-1-1"], dtype="datetime64[ns]"), "DayOfWeek": pd.Series([0], dtype="int64"), "Open": pd.Series([0], dtype="int64"), "Promo": pd.Series([0], dtype="int64"), "StateHoliday": pd.Series(["example_value"], dtype="object"), "SchoolHoliday": pd.Series([0], dtype="int64")})
try:
